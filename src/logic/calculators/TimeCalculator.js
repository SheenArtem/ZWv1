...
export const calculateLiuNian = (subBranchIndex) => {
...
export const calculateLiuYue = (liuNianIndex, // Current Year Branch Index
birthMonth, // Lunar Birth Month (1-12)
birthHourIndex, // Lunar Birth Hour Branch Index (0-11)
targetMonth // Targeted Lunar Month (1-12)
) => {
