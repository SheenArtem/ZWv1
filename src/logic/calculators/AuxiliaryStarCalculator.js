...
export const calculateAuxiliaryStars = (yearBranchIndex, // Year Zhi
lunarMonth, // 1-12
lunarHourIndex, // 0-11
lunarDay // 1-30
) => {
    ...
    if (isIn([11, 0, 1], yearBranchIndex)) {
        stars['孤辰'] = 2;
        stars['寡宿'] = 10;
    }
    else if (isIn([2, 3, 4], yearBranchIndex)) {
        stars['孤辰'] = 5;
        stars['寡宿'] = 1;
    }
    else if (isIn([5, 6, 7], yearBranchIndex)) {
        stars['孤辰'] = 8;
        stars['寡宿'] = 4;
    }
    else {
