...
export const calculateMinorStars = (yearGanIndex, lunarMonth, lunarHourIndex, yearZhiIndex) => {
    const stars = {};
    ...
    const isIn = (arr, val) => arr.includes(val);
    ...
    if (isIn([2, 6, 10], yearZhiIndex))
        stars['天馬'] = 8;
    else if (isIn([8, 0, 4], yearZhiIndex))
        stars['天馬'] = 2;
    else if (isIn([5, 9, 1], yearZhiIndex))
        stars['天馬'] = 11;
    else
        stars['天馬'] = 5;
    return stars;
