...
export interface PalacePositions {
    mingIndex: number; // 0-11, where 0=Zi
    shenIndex: number;
    palaces: string[]; // Returns the Earthly Branch assigned to each of the 12 semantic palaces (Life, Sibling...)
}
